...
def parse_three_digit_num(money):
    # Применяем функцию parse_two_digit_num и добавляем Dict3
    parse_two_digit_num(money)
    money //= 100
...
while (True):
    try:
        ...
        print("Ошибка: Неверно введено число, попробуйте ещё раз!")
        continue

    if money < 1 or money > 999999:
        print("Ошибка: Значение не входит в диапазон [1, 999999], попробуйте ещё раз!")
        continue
    break
